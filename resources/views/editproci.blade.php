...
<body>
  <h1 class="own_h1">Editing the selected processor</h1>
    <form class="forms" action= "{{route('modifyproci',[$pizza->id])}}" method="POST" >
      @csrf <!-- {{ csrf_field() }} -->
  <label class="own_label_1" for="id">Processor id:</label><br>
  <input type="number" id="id" name="id" value="{{$pizza->id}}">
  <br><br>
  ...
  <label class="own_label_1" for="manufacturer">Processor type:</label><br>
