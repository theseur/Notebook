...
<body>
  <h1 class="own_h1">Create a new user</h1>
    <form class="forms" action= "{{route('insertusers')}}" method="POST" >
      @csrf <!-- {{ csrf_field() }} -->
  ...
  <input type="checkbox" name="hidden" ><br><br>
  <label class="own_label_1" for="admin">admin</label>
  <input type="checkbox" name="admin" ><br><br>
  <label class="own_label_1" for="updated_at">updated_at:</label><br>
  <input type="datetime" id="updated_at" name="updated_at" ><br><br>
  <label class="own_label_1" for="created_at">created_at:</label><br>
  <input type="datetime" id="created_at" name="created_at" ><br><br>
  <div class="gombok_2">
